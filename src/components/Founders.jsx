      ...
      <div className="founders-wrapper">
        <div className="founder">
          ...
          <div className="founder-info">
            ...
            <p className="founder-role"><em>Chief Medical Officer</em> <br/> <em>Board‑Certified Dermatologist</em></p>
            <p>
        ...
        <div className="founder">
          ...
          <div className="founder-info">
            <h3>Oded Harth</h3>
            <p className="founder-role"><em>CEO</em><br/><em>Forbes ‘30 Under 30’</em></p>
            <p>
